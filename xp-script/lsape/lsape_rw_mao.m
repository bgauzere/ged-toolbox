...
dataset=[dataset_path 'dataset_mao.ds'];
...
mapping_time_lsape_mao = 0;

ed_lsape_rw_mao = zeros(N,N);
...
for i = 1:N
    for j = 1:N
       ...
       mapping_time_lsape_mao =  mapping_time_lsape_mao + mapping_time;
        
       ed_lsape_rw_mao(i,j) = val;
    end
end
