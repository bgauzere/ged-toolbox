...
dataset=[dataset_path 'dataset_alkane.ds'];
...
mapping_time_lsape_alkane = 0;

ed_lsape_rw_alkane = zeros(N,N);
...
for i = 1:N
    for j = 1:N
       ...
       mapping_time_lsape_alkane =  mapping_time_lsape_alkane + mapping_time;
        
       ed_lsape_rw_alkane(i,j) = val;
    end
end
