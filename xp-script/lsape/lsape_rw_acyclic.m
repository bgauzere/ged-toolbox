...
mapping_time_lsape_acyclic = 0;

ed_lsape_rw_acyclic = zeros(N,N);
...
for i = 1:N
    for j = 1:N
       ...
       mapping_time_lsape_acyclic =  mapping_time_lsape_acyclic + mapping_time;
        
       ed_lsape_rw_acyclic(i,j) = val;
    end
end
